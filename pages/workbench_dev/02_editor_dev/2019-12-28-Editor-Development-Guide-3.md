---
title: "포틀릿 xml 파일 설정"
permalink: workbench_editorguide3.html
...
이전 단계에서 설명한 바와 같이 포틀릿의 구성 정보를 설정하는 `TextEditorPortletConfigAction.java` 파일을 추가하였습니다. <br>
해당 파일과 포틀릿을 연결시키기 위해 `liferay-portlet.xml`파일에 해당 내용을 추가합니다.<br>

추가해야 하는 내용은 다음과 같습니다.<br>
```xml
<configuration-action-class>com.kisti.osp.visualizer.portlet.texteditor.TextEditorPortletConfigAction</configuration-action-class>
```
...
<liferay-portlet-app>
	...
	<portlet>
		<portlet-name>text-editor</portlet-name>
		<icon>/icon.png</icon>
		<configuration-action-class>com.kisti.osp.visualizer.portlet.texteditor.TextEditorPortletConfigAction</configuration-action-class>
		...
		<css-class-wrapper>text-editor-portlet</css-class-wrapper>
		<add-default-resource>true</add-default-resource>
	</portlet>
	<role-mapper>
...
라이프레이 기본적으로 구성되는 프로젝트 구조에서 `/html/TextEditor`폴더 내에 configuration.jsp 파일을 추가합니다.
...
이와 마찬가지로 `portlet.xml`내에 configuration 파라미터를 설정해야 합니다.
추가해야 하는 xml 코드는 다음과 같습니다.<br>

```xml
<init-param>
	<name>config-template</name>
	<value>/html/TextEditor/configuration.jsp</value>
</init-param>
```
...
<portlet-app xmlns="http://java.sun.com/xml/ns/portlet/portlet-app_2_0.xsd" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://java.sun.com/xml/ns/portlet/portlet-app_2_0.xsd http://java.sun.com/xml/ns/portlet/portlet-app_2_0.xsd" version="2.0">
	...
	<portlet>
		<portlet-name>text-editor</portlet-name>
		<display-name>Text Editor</display-name>
		<portlet-class>
			com.kisti.osp.visualizer.portlet.texteditor.TextEditorPortlet
		</portlet-class>
		<init-param>
			<name>view-template</name>
			<value>/html/TextEditor/visualizer-wrapper.jsp</value>
		</init-param>
		<init-param>
			<name>config-template</name>
			<value>/html/TextEditor/configuration.jsp</value>
		...
		<portlet-info>
			...
			<short-title>Text Editor</short-title>
			<keywords></keywords>
		</portlet-info>
		<security-role-ref>
			<role-name>administrator</role-name>
